    ...
    try {
        ...
        if (response.ok) {
          ...
          setUserData({
            ...
            DietaryPreferance: data.DietaryPreferance ? JSON.parse(data.DietaryPreferance).dietaryPreference : '',
            allergy: data.allergy ? JSON.parse(data.allergy).allergy : '',
            DietMethod: data.DietMethod ? JSON.parse(data.DietMethod).dietMethod : '',
            HealthGoal: data.HealthGoal ? JSON.parse(data.HealthGoal).healthGoal : '',
            height: data.height,
            Weight: data.Weight,
            BMI: data.BMI,
          });
