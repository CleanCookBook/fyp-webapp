      ...
      <div className="bg-white w-[1600px] h-[560px] absolute top-[95px] left-15 font-black text-2xl px-7 shadow-md">
        <span className="text-xl font-bold absolute top-[15px]">Terms and Conditions </span>
          <ol class="text-black text-base font-semibold pb-5 absolute top-[55px]">
            <li><b>LEligibility:</b> To use this website, you must be at least 18 years old and have the capacity to enter into a binding agreement. If you are under 18, you may only use this website with the involvement of a parent or legal guardian who agrees to be bound by these Terms and Conditions.</li>
