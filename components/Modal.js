  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center">
      <div className="bg-white p-8 rounded-3xl shadow-2xl">
        ...
        <h1 className="text-2xl font-bold mb-4 underline text-blue-900">Filter</h1>
        <div className="flex">
          {/* Left Section: Dietary Preference */}
          <div className="flex flex-col pr-4 border-r border-blue-900">
            <h2 className="text-lg font-semibold mb-2 text-blue-900">Dietary Preference</h2>
            ...
            <h2 className="text-lg font-semibold mb-2 text-blue-900">Cooking Time</h2>
            ...
            <div className="border-b my-2 border-blue-900"></div>
            {/* Calories heading */}
            <h2 className="text-lg font-semibold mb-2 text-blue-900">Calories</h2>
            {/* Calories input box */}
            <div className="flex items-center mb-1">
              <input type="number" className="mr-2 p-2 border rounded" placeholder="Enter calories" />
          ...
          <div className="flex flex-col pl-4">
            <h2 className="text-lg font-semibold mb-2 text-blue-900">Allergy</h2>
            <label className="flex items-center mb-1">
        ...
        <div className="flex justify-end mt-4 space-x-4">
            <button type="button" onClick={handleClear} className="text-blue-900 hover:text-blue-700">
              Clear
            </button>
            <button type="submit" className="bg-blue-900 text-white px-4 py-2 rounded">
              Submit
            </button>
            <button type="button" onClick={onClose} className="bg-blue-900 text-white px-4 py-2 rounded">
              Close
            </button>
          </div>
        </form>
