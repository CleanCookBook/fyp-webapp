    ...
    return (
        <div className="flex flex-col h-screen justify-center items-center bg-[#F9D548] text-[#0A2A67]">
            <div className="lg:w-1/2 lg:pr-8 ">
                <h2 className="text-5xl font-black p-5">Take Your First Step To <br/> Better Eating </h2>
            
            <div className="flex lg:flex-row mx-8">
                <div classname="flex w-1/2">
                    <div class="w-[400px] h-[60px] flex-col justify-start items-start inline-flex">
                        <div class="justify-start items-start gap-2.5 inline-flex">
                            <div class="text-blue-950 text-sm font-medium">First Name :</div>
                        </div>
                        <div class="w-[404px] h-8 pl-2.5 py-2.5 bg-white rounded-[10px] justify-start items-start gap-2.5 inline-flex">
                            <div class="justify-center items-start gap-2.5 flex">
                                <div class="text-neutral-400 text-[10px] font-medium">Enter your First Name</div>
                            </div>
                        </div>
                    </div>
                    <br/>
                    <div class="w-[400px] h-[60px] flex-col justify-start items-start inline-flex">
                        ...
                        <div class="w-[404px] h-8 pl-2.5 py-2.5 bg-white rounded-[10px] justify-start items-start gap-2.5 inline-flex">
                            <div class="justify-center items-start gap-2.5 flex">
                                <div class="text-neutral-400 text-[10px] font-medium">Enter your Last Name</div>
                            </div>
                        </div>
                    </div>
                    <br/>
                    ...
                    <div className="w-1/2">
                        <img className="w-[400px] h-[400px] drop-shadow-lg" src="login-signupPage.jpg" alt="Sign Up Image" />
                    </div>
