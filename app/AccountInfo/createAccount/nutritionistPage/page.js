...
const BusinessPartnerSignup = () => {
  ...
  return (
    <div className="flex flex-col h-screen justify-center items-center bg-[#F9D548] text-[#0A2A67]">
      ...
      <div className="flex-grow lg:w-4/5 lg:pr-8 p-8 h-screen flex flex-col items-center">
        <h2 className="text-6xl font-black pb-8 mt-3">
          Join Us and Change the World{" "}
        </h2>
        <div className="lg:w-4/5 lg:pr-8 p-8 flex items-center -mt-10">
          <div className="w-1/2 border-r border-gray-400 pr-8">
            ...
            >
              ...
              <label
                htmlFor="linkedinUrl"
                className="text-blue-950 text-lg font-medium mt-10 ml-2.5 self-start"
              >
              ...
              <input
                ...
                className="text-neutral-400 text-medium font-medium border-none outline-none w-full h-10 pl-2.5 py-2.5 bg-white rounded-[10px] mb-4 self-start"
                placeholder="https://www.linkedin.com/in/yourprofile"
                required
              />
              <label
                htmlFor="uploadLicense"
                className="text-blue-950 text-lg font-medium mt-3 ml-2.5 self-start"
              >
                Upload your License:
              </label>
          ...
          <div className="w-1/2 pl-8">
            <form onSubmit={handleSubmit} className="flex flex-col items-start">
              ...
              <label
                ...
                className="text-blue-950 text-lg font-medium mt-16 ml-2.5 self-start"
              >
              ...
              <div>
                <button
                  type="submit"
                  className="w-[259px] h-10 bg-blue-950 hover:bg-[#154083] text-white font-bold rounded-[10px] shadow self-end mt-28 ml-72"
                >
                  Submit
                </button>
              </div>
