...
<div className="flex flex-col h-full bg-[#F9D548]">
    ...
    <div className="w-full max-w-md flex flex-row mt-7">
        ...
        <div className="flex flex-col mt-9 ml-8 gap-1">
          <h1 className="flex flex-row text-2xl font-bold text-black">{formData.FName} {formData.LName}</h1>
    ...
    <form action="/update-account" method="POST" onSubmit={submitForm}>
        <div>
            ...
            <label className="flex flex-row text-xl text-black font-semibold mt-2">Dietary Preference :</label>
            <Select
                isMulti
                name="DietaryPreferance"
                options={selectOptions.DietaryPreferanceOptions}
                classNamePrefix="select"
                onChange={(options) => handleOptionsChange('DietaryPreferences', options)}
            ...
            <Select
                ...
                classNamePrefix="select"
                onChange={(options) => handleOptionsChange('Allergies', options)}
            ...
            <div className="flex flex-row mt-9 gap-4">
                <label className="flex flex-row text-xl text-black font-semibold mt-2">Diet Method :</label>
                <Select
                isMulti
                name="DietMethod"
                options={selectOptions.DietMethodOptions}
                classNamePrefix="select"
                onChange={(options) => handleOptionsChange('DietMethods', options)}
            ...
            <div className="flex flex-row mt-9 gap-4">
                ...
                classNamePrefix="select"
                onChange={(options) => handleOptionsChange('HealthGoals', options)}
